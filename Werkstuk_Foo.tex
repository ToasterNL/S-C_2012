...
\begin{center}
    ...
    \$i, \$c, \$h                           & 1 & Drukt een enkele waarde af. Er zijn drie mogelijkheden: druk af als integer (i), druk af als hexadecimaal integer (h) en als ASCII karakter (c). Als er niet zo een `format string' wordt gespecificeerd wordt er een foutmelding gegeven door de interpreter. \\ \hline %hier moet nog naar gekeken worden
    ...
    \#\(n\)                                 & 1 & Pauzeert de uitvoering van het programma voor een opgegeven aantal seconden. \\ \hline %wat gebeurd er als er niks wordt opgegeven
...
\AxiomC{$\langle >, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma+1, AV, \rho, \theta, O)$}
\
\end{prooftree}
...
\AxiomC{$\langle \&i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma] \mapsto i, \rho, \theta, O)$}
\end{prooftree}
...
\AxiomC{$\langle @, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, i \| \theta, O)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle +a, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV[\sigma] \mapsto AV[\sigma]+a, \rho, \theta, O)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle \$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| AV[\sigma])$}
\end{prooftree}

De $print^{ci}_{ns}$ regel print de direct opvolgende waarde als 'character' naar de standard output.
\begin{prooftree}
\AxiomC{$\langle \$in, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| n)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle \$in, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| ascii(n))$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle \$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| ascii(hex(AV[\sigma])))$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle \$in, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| ascii(hex(n)))$}
\end{prooftree}
