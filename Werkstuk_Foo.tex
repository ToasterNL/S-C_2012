...
\AxiomC{$\langle \&, (\sigma, AV(\sigma), \rho, \theta, O) \rangle \rightarrow (\sigma, AV(\sigma) \mapsto \theta(1), \rho, \theta(2..), O)$}
\end{prooftree}
...
\begin{prooftree}
	\AxiomC{$\langle +, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV[\sigma] \mapsto AV[\sigma] + \theta(1), \rho, \theta-1, O)$}
\end{prooftree}
