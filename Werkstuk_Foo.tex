...
\begin{prooftree}
	\AxiomC{$\langle \&10,  (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto 10], \rho, \theta, O)$}
			\AxiomC{$\langle \#1-1\$i\$c10, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto AV[\sigma] - 1], \rho, \theta, O)$}
					\AxiomC{$\langle \#1-1\$i\$c10, s \rangle \rightarrow s'$}								
					\AxiomC{$\langle (0\#1-1\$i\$c10), s \rangle \rightarrow s'$}
				\BinaryInfC{$\langle (0\#1-1\$i\$c10), s \rangle \rightarrow s'$}

			\BinaryInfC{$\langle (0\#1-1\$i\$c10), (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto 0], \rho, \theta, O)$}
