...
\begin{center}
    ...
    \$i$i$, \$c$i$, \$h$i$                  & 1 & Drukt een enkele waarde af. Er zijn drie mogelijkheden: druk af als integer (i), druk af als hexadecimaal integer (h) en als ASCII karakter (c). Als er niet zo een `format string' wordt gespecificeerd wordt er een foutmelding gegeven door de interpreter. Het argument \(i\) wordt afgedrukt. \\ \hline
    ...
    \#\(i\)                                 & 1 & Pauzeert de uitvoering van het programma voor een opgegeven \(i\) aantal seconden. \\ \hline %wat gebeurd er als er niks wordt opgegeven
...
\AxiomC{$\langle $@$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, i \| \theta, O)$}
\end{prooftree}
...
\AxiomC{$\langle $($S$)$, s \rangle \rightarrow s' $}
\AxiomC{$\langle $($i-1 S$)$, s' \rangle \rightarrow s''$}
\BinaryInfC{$\langle $($iS$)$, s \rangle \rightarrow  s''$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle $+$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV[\sigma] \mapsto AV[\sigma]+i, \rho, \theta, O)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle $\$ci$, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| i)$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle $\$i$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| ascii(i))$}
\end{prooftree}
...
\begin{prooftree}
\AxiomC{$\langle $\$h$i, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho, \theta, O \| ascii(hex(i)))$}
\end{prooftree}
