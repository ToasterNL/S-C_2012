		...
		\BinaryInfC{$\langle (0\#1-1\$i\$c10),  (\sigma, AV[\sigma \mapsto 3], \rho, \theta, O) \rangle \rightarrow s_{12}$}	
			%\AxiomC{$T_1$}
				...
				%\AxiomC{bla2}
					%\AxiomC{bla1}
					%\AxiomC{bla3}
				%\BinaryInfC{$\langle ''boom!''\$c10, s_{12}  \rangle \rightarrow (s) $}
				\AxiomC{$T_4$}
...
Het programma ziet er als volgt uit: \verb|&3(0#1-1$i$c10)"boom!"$c10|.
De afleidingsboom wordt weergegeven in Figure ...
