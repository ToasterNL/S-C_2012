...
$[/_{ns}]$	&	\AxiomC{$\langle $/$, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV, \rho+\Delta, \theta, O \| $"Stack is empty"$ \| newline \| $"Only Chuck Norris can divide by zero"$ \| newline)$}
		  \DisplayProof & $if {\cal B} _{[\theta[0] \neq undefined \land n \neq 0]s} == ff $
