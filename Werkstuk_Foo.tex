...
$[Loop_{ns}^{tt^1}]$	&	\AxiomC{$\langle $S$, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV[\sigma]-1, \rho, \theta, O)  $}
					\AxiomC{$\langle $($ S$)$,  (\sigma, AV[\sigma]-1, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma]-1, \rho, \theta, O)$}
					\BinaryInfC{$\langle $($nS$)$, s \rangle \rightarrow  (\sigma, AV[\sigma]-1, \rho, \theta, O)$}
...
\begin{landscape}
\begin{prooftree}
\AxiomC{$\langle \&10,  (\sigma = 0, AV, \rho = 0, \theta, O) \rangle \rightarrow (\sigma = 0, AV[\sigma] \mapsto 10, \rho = 0, \theta, O)$}

					\AxiomC{$\langle (0, s \rangle \rightarrow s'$}								
											\AxiomC{$\langle \#1, s \rangle \rightarrow s'$}

							\BinaryInfC{$\langle (0, s \rangle \rightarrow s'$}
														
														\AxiomC{$\langle \#1, s \rangle \rightarrow s'$}

																						\AxiomC{$\langle-1\$i\$c10)''boom!''\$c10, s \rangle \rightarrow s'$}

																		\BinaryInfC{$\langle \#1-1\$i\$c10)''boom!''\$c10, s \rangle \rightarrow s'$}

																\BinaryInfC{$\langle (0\#1-1\$i\$c10)''boom!''\$c10, (\sigma = 0, AV[\sigma] \mapsto 10, \rho = 0, \theta, O) \rangle \rightarrow s''$}

							\BinaryInfC{$\langle \&10(0\#1-1\$i\$c10)''boom!''\$c10, (\sigma = 0, AV, \rho = 0, \theta, O) \rangle \rightarrow  s''$}
\end{prooftree}
\end{landscape}
