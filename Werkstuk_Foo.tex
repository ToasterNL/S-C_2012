...
\centering
\begin{prooftree}
			\AxiomC{$\langle \$i\$c10, (\sigma, AV, \rho = 0, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| AV[\sigma] \| newline)$}
			...
			\UnaryInfC{$\langle \#1-1\$i\$c10, s \rangle \rightarrow s'$}
				\AxiomC{$\langle (0\#1-1\$i\$c10), s' \rangle \rightarrow s''$}

			\BinaryInfC{$\langle (0\#1-1\$i\$c10), s \rangle \rightarrow s'' $}
\end{prooftree}
\end{figure}
...
\begin{prooftree}
	\AxiomC{$\langle \&10,  (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto 10], \rho, \theta, O)$}
			...
			\AxiomC{$\langle ''boom!''\$c10, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| ``Boom!'' \| newline)$}

		\BinaryInfC{$\langle (0\#1-1\$i\$c10)''boom!''\$c10, (\sigma , AV, \rho , \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| ``Boom!'' \| newline)$}

	\BinaryInfC{$\langle \&10(0\#1-1\$i\$c10)''boom!''\$c10, (\sigma = 0, AV, \rho = 0, \theta, O) \rangle \rightarrow  (\sigma = 0, AV, \rho = 0, \theta, O \| ``Boom!'' \| newline)$}
\end{prooftree}
\end{figure}
\end{landscape}
