...
\begin{prooftree}
			\AxiomC{$\langle \$i\$c10, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| AV[\sigma] \| newline)$}
			\UnaryInfC{$\langle -1\$i\$c10, (\sigma, AV, \rho+1, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto AV[\sigma] - 1], \rho, \theta, O \| AV[\sigma] \| newline)$}
			\UnaryInfC{$\langle \#1-1\$i\$c10, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto AV[\sigma] - 1], \rho, \theta, O \| AV[\sigma] \| newline)$}
			\AxiomC{$\langle (0\#1-1\$i\$c10), s \rangle \rightarrow s'$}
			\BinaryInfC{$\langle (0\#1-1\$i\$c10), (\sigma, AV, \rho, \theta, O) \rangle \rightarrow s'$}
				\AxiomC{$\langle (0\#1-1\$i\$c10), s \rangle \rightarrow s'$}

			\BinaryInfC{$\langle (0\#1-1\$i\$c10), (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto 0], \rho = 0, \theta, O)$}
\end{prooftree}

\begin{prooftree}
	\AxiomC{$\langle \&10,  (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV[\sigma \mapsto 10], \rho, \theta, O)$}
			\AxiomC{$S_1$}

			\AxiomC{$\langle ''boom!''\$c10, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| ``Boom!'')$}

		\BinaryInfC{$\langle (0\#1-1\$i\$c10)''boom!''\$c10, (\sigma , AV, \rho , \theta, O) \rangle \rightarrow (\sigma, AV, \rho, \theta, O \| ``Boom!'')$}

	\BinaryInfC{$\langle \&10(0\#1-1\$i\$c10)''boom!''\$c10, (\sigma = 0, AV, \rho = 0, \theta, O) \rangle \rightarrow  (\sigma = 0, AV, \rho = 0, \theta, O \| ``Boom!'')$}
\end{prooftree}
\end{landscape}
