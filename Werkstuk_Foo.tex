...
Naar onze mening inzicht is het onderscheid tussen output en errors duidelijk, aangezien het gebruik van de standard output zich beperkt tot een specifieke set regels.
