...
\begin{tabular}{ | l | p{12cm} |}
    ...
    \begin{math} \theta \end{math} & Dit symbool staat voor de stack. \begin{math}\theta[0]\end{math} staat voor de eerste waarde van de stack. \\ \hline %MEER UITLEG OVER STACK GEBRUIK MET SYMBOLEN
...
\end{tabular}
\newline
\indent\indent\indent\indent$if {\cal B} _{[n \neq 0]s} == ff $
\newline
%\end{table}
%\begin{prooftree}
%	\AxiomC{$\langle $/$n, (\sigma, AV, \rho, \theta, O) \rangle \rightarrow  (\sigma, AV[\sigma] \mapsto AV[\sigma]/n, \rho, \theta, O)$}
