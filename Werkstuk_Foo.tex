...
\BinaryInfC{$\langle S_{1}S_{2}, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow  s''(\sigma, AV(\sigma), \rho)$}
\end{prooftree}

%#-REGEL, LABEL STAAT ER NIET !!!
\begin{prooftree}
\LeftLabel{$[\#_{ns}]$:\quad}
\AxiomC{$\langle \#, s(\sigma,  AV(\sigma), \rho) \rangle \rightarrow s(\sigma,  AV(\sigma), \rho) $}
\end{prooftree}
%LOOP-REGELS:
...
\AxiomC{$\langle S, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow s'(\sigma, AV(\sigma), \rho)$}
\AxiomC{$\langle nS, s'(\sigma, AV(\sigma), \rho) \rangle \rightarrow s''(\sigma, AV(\sigma), \rho)$}
\BinaryInfC{$\langle nS, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow  s''(\sigma, AV(\sigma), \rho)$}
\end{prooftree}
...
\AxiomC{$\langle S, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow s'(\sigma, AV(\sigma), \rho)$}
\AxiomC{$\langle S, s'(\sigma, AV(\sigma), \rho) \rangle \rightarrow s''(\sigma, AV(\sigma), \rho)$}
\BinaryInfC{$\langle S, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow  s''(\sigma, AV(\sigma), \rho)$}
\end{prooftree}
...
%Arimetische expressies

\begin{prooftree}
\AxiomC{$\langle +a, s(\sigma, AV(\sigma), \rho) \rangle \rightarrow  s'(\sigma, AV(\sigma)+a, \rho)$}
\end{prooftree}
